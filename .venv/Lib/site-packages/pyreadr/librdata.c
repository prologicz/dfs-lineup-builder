 ...
 */
  __pyx_t_1 = (__Pyx_PyUnicode_Equals(__pyx_v_mode, __pyx_n_u_r, Py_EQ)); if (unlikely(__pyx_t_1 < 0)) __PYX_ERR(0, 26, __pyx_L1_error)
  if (__pyx_t_1) {
 ...
 *         else:
 */
    __pyx_t_2 = PyUnicode_AsWideCharString(__pyx_v_path, (&__pyx_v_length)); if (unlikely(__pyx_t_2 == ((wchar_t *)NULL))) __PYX_ERR(0, 28, __pyx_L1_error)
    __pyx_v_u16_path = __pyx_t_2;
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_fsdecode); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
    ...
    __pyx_t_2 = PyUnicode_AsWideCharString(__pyx_t_3, (&__pyx_v_length)); if (unlikely(__pyx_t_2 == ((wchar_t *)NULL))) __PYX_ERR(0, 32, __pyx_L1_error)
